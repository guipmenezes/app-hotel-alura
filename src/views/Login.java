...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/imagensView/img-hotel-login-.png")));
		...
		logo.setIcon(new ImageIcon(Login.class.getResource("/imagensView/lOGO-50PX.png")));
