...
public class ReservasView extends JFrame {
	...
	public ReservasView() throws ParseException {
		...
		txtDataE.getCalendarButton()
				.setIcon(new ImageIcon(ReservasView.class.getResource("/imagensView/icon-reservas.png")));
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/imagensView/Ha-100px.png")));

		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/imagensView/reservas-img-3.png")));
	...
	public String valorReserva() {
		...
		Long difencaEmMilisegundos = diffSaida - diffEntrada;
		Long calculoPreco = (difencaEmMilisegundos / 24) / 100000;

		String precoFinal = String.valueOf(calculoPreco);
	...
	public void salvarReserva() {
		try {
			...
			Reservas reserva = new Reservas(dataSql(dataEntrada), dataSql(dataSaida), valor,
			...
			JOptionPane.showConfirmDialog(contentPane,
					"A reserva foi realizada. Reserva de número: " + reserva.getId() + " e no valor de: " + valorReserva());
