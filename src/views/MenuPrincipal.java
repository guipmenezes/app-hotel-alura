...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuPrincipal.class.getResource("/imagensView/aH-40px.png")));
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagensView/menu-img.png")));
		panel.add(imagenFondo);
		
		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);
		logo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagensView/aH-150px.png")));
		panel.add(logo);
		...
		lblCopyR.setBounds(263, 11, 367, 19);
		...
		imageLogin.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagensView/login.png")));
