...
public class Sucesso extends JDialog {
	 ...
	 */
	public Sucesso() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Sucesso.class.getResource("/imagensView/aH-40px.png")));
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Sucesso.class.getResource("/imagensView/Ha-100px.png")));
